  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 p-4">
      ...
      <div className="mb-6 px-6 py-4 rounded-xl bg-white/80 backdrop-blur-sm border border-green-200 shadow-lg">
        ...
        {printProperty("EncryptChat Contract", fheCounter.contractAddress)}
        {printProperty("Is Deployed", fheCounter.isDeployed)}
      </div>

      <div className="mb-6 px-6 py-4 rounded-xl bg-white/80 backdrop-blur-sm border border-green-200 shadow-lg">
        <p className={titleClass}>💬 Message Statistics</p>
      ...
      <div className="mb-6 px-6 py-4 rounded-xl bg-white/80 backdrop-blur-sm border border-green-200 shadow-lg">
        ...
        <div className="grid grid-cols-1 gap-2 mt-2">
          ...
          <input
            type="text"
            placeholder="Message Content (max 8 bytes)"
            value={messageText}
        ...
        >
          {fheCounter.canSendMessage && recipientAddress && messageText
            ...
            : fheCounter.isSending
              ? "Sending..."
              : "Enter recipient address and message content"}
        </button>
        <button
          className={buttonClass}
      ...
      <div className="mb-6 px-6 py-4 rounded-xl bg-white/80 backdrop-blur-sm border border-green-200 shadow-lg">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="rounded-xl bg-white/80 backdrop-blur-sm border border-green-200 shadow-lg pb-4 px-6">
          ...
          <div className="rounded-xl bg-white/80 backdrop-blur-sm border border-green-200 shadow-lg pb-4 px-6">
            ...
            {printProperty("Is Refreshing", fheCounter.isRefreshing)}
            {printProperty("Is Decrypting", fheCounter.isDecrypting)}
            {printProperty("Is Sending", fheCounter.isSending)}
            {printProperty("Can Get Messages", fheCounter.canGetMessages)}
            {printProperty("Can Decrypt", fheCounter.canDecrypt)}
            {printProperty("Can Send Message", fheCounter.canSendMessage)}
          </div>
        </div>
      </div>
      <div className="p-6 rounded-xl bg-white/80 backdrop-blur-sm border border-green-200 shadow-lg">
